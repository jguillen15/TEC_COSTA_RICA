...
gamma_1 = 0.0022;
gamma_2 = 0.00052;
%PBAD_time = [9695  13295  16895  20495  22295];%old
%PBAD_fluo = [90000 220000 420000 520000 540000];%old
PBAD_time = [10000  15000  20000  25000  30000];%new
PBAD_fluo = [25000  48000  62000  71000  77000];%new
%Pnrd_time = [0     1080   2700 3780   4860];
%Pnrd_fluo = [25000 26500 27500 28500 31000];
k_PBAD = 0;
k_Pnrd = 0;
for i=1:(length(PBAD_time)-2)
    for j=(i+1):(length(PBAD_time)-1)
        for k=(j+1):(length(PBAD_time))
            t1 = PBAD_time(i);
            f1 = PBAD_fluo(i);
            t2 = PBAD_time(j);
            f2 = PBAD_fluo(j);
