function Func = func_single_counter1(t,y,Dtot,Kir,Kr1,Kr2,Ksyn,Ksynr,KbI,Klri,k1,k2,k3,conc_pulse,time_ind)
%Pulso arabinosa
ara_on = 0;
ara_off = ara_on + time_ind;
kt = 0.03;

puls = conc_pulse*(tanh((t-ara_on)/kt)-tanh((t-ara_off)/kt)); 
...
Func(4) = 4*k1*k_int*y(6) - 1*k3*k_dil*y(4); %Integrase protein
...
Func(5) = 0;
Func(6) = k_tscr*puls - 1*k2*k_rna*y(6);%Integrase mRNA
